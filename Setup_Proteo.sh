...
selection=$(zenity --list --checklist \
	...
	FALSE 	10 	"MODICT"			"9.06"\
	FALSE	:	"**** Contact Map Prediction ****" " "\
	FALSE	11	"C2S"				"30.7"\
	FALSE	12	"FP Filter" 			"2.20"\
	FALSE	13	"Pconsc"			"1.0"\
	FALSE	14	"CCMPred"			"0.15"\
	FALSE	15	"bbcontacts"			"1.06"\
	FALSE	16	"BCL"				"168"\
	FALSE	17	"FreeContact"			"0.40"\
	FALSE	18	"PyMDmix"			"9.72"\
	...
	FALSE	25	"RawMSA"			"0.27"\
	FALSE	26	"COUSCOus"			""\
	FALSE	27	"RADI"				""\
	FALSE	:	"*** Co-evolving Residue Prediction ***" " "\
	FALSE	28	"cooccurNET" 			""\
	FALSE	29	"CorMut"			""\
	FALSE	30	"EVCouplings"			""\
	...
	FALSE	34	"VanoShaper"			""\
	FALSE	35	"POVME"				""\
	FALSE	36	"Protein Volume"		""\
	FALSE	:	"*** Repetitive Element Prediction ***" " "\
	FALSE	37	"CE-Symmetry"			""\
	FALSE	38	"ReUPred"			""\
